...
class ExcelGUI:
    def __init__(self, root):
        ...
        self.description_tree.column("Description", width=780, minwidth=200, stretch=True)
        ...
        self.description_tree.configure(height=fixed_height)
