...
class ExcelController:
    ...
    def _load_mtp_map_tab(self):
        ...
        # Fill NaN values in 'Sub Field Name' and 'Description' with previous values
...
class ExcelGUI:
    ...
    def on_tree_select(self, event):
        ...
        if selected_item:
            ...
            # Find all rows matching the selected address
            description_rows = self.controller.dataframe[self.controller.dataframe['MTP address'] == address]
