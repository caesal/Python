# -*- coding: utf-8 -*-
"""
Created on Mon Jan 13 12:03:44 2025
...
# Constants
GUI_VERSION = 'MTP Alchemist Ver0.1.00'
GUI_SIZE = '1920x900'
GUI_THEME = 'clam'  # e.g., 'winnative', 'clam', 'alt', 'default', 'classic', 'vista', 'xpnative'

SOURCE_EXCEL = r"Sirius_OTP_Fusemap_v27p1_PythonSourceExcel.xlsx"
...
class ExcelController:
    def __init__(self, filepath):
        ...
        self.ovst_dataframe = self._load_ovst_map_tab()
    ...
    def _load_ovst_map_tab(self):
        df = pd.read_excel(self.modified_path, sheet_name='OVST Map', header=7)
        df.rename(columns={
            df.columns[0]: 'MTP address',
            df.columns[2]: 'Field width',
            df.columns[4]: 'Record Field',
    ...
    def _load_ovst_description_tab(self):
        df = pd.read_excel(self.modified_path, sheet_name='OVST Description', header=7)
        df.rename(columns={
            df.columns[6]: 'Sub Field Name',  # G
            df.columns[7]: 'Description',     # H
            df.columns[0]: 'MTP address'      # A
...
class ExcelGUI:
    ...
    def create_button_frame(self):
        ...
        self.option_menu = ttk.OptionMenu(button_frame, self.option_var, "mtpconfig", "mtpconfig", "mtpfull", "mtpproduct", "codepatch")
    ...
    def on_register_select(self, event):
        ...
        if selected_address and selected_address.startswith("0x"):
            ...
            if tab_name == "CONFIGURATION":
                ...
                description_df = self.controller.ovst_description_dataframe
            else:
                description_df = None
